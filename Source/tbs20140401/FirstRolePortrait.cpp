...
void UFirstRolePortrait::RefreshByUnit(TObjectPtr<AMyUnit> Unit)
{
	...
	if(!pData->Assets.JobIcon.IsValid())
	{
		pData->Assets.JobIcon.LoadSynchronous();
	}
	JobIcon->SetBrushFromTexture(pData->Assets.JobIcon.Get(),false);
